      ...
      <View style={styles.screen}>
        ...
        <View style={styles.resultContainer}>
          <Text style={styles.descriptionText}>
            ...
            <Text style={styles.titleText}>{props.roundsNumber} </Text> Number
            was : <Text style={styles.titleText}>{props.userNumber} </Text>
          </Text>
        </View>
        <CustomButton
          overridenStyle={{
...
const styles = StyleSheet.create({
  ...
  image: {
    ...
    borderRadius: (Dimensions.get("window").width * 0.8) / 2.0,
    borderColor: "black",
    borderWidth: 1,
    marginTop: 30,
  },
  ...
  descriptionText: {
    ...
    fontSize: Dimensions.get("window").height < 400 ? 14 : 24,
    marginBottom: 20,
  },
  resultContainer: {
    width: "70%",
